...
# Add any Sphinx extension module names here, as strings. They can be extensions  # noqa E501
...
latex_documents = [
  ('index', 'django-registration-redux.tex', u'django-registration-redux Documentation',  # noqa E501
