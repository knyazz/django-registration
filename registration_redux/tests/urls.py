"""
URLs used in the unit tests for django-registration_redux.

You should not attempt to use these URLs in any sort of real or
development environment; instead, use
``registration_redux/backends/default/urls.py``. This URLconf includes those
...
urlpatterns = [
    ...
    # on successful registration_redux.
    ...
    url(r'^custom-success/$',
        TemplateView.as_view(template_name='registration_redux/test_template_name.html'),
