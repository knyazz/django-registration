...
urlpatterns = patterns(
    ...
    url(r'^custom-disallowed/$',
        TemplateView.as_view(template_name='registration/registration_closed.html'),  # noqa E501
    ...
    url(r'^custom-success/$',
        TemplateView.as_view(template_name='registration/test_template_name.html'),  # noqa E501
